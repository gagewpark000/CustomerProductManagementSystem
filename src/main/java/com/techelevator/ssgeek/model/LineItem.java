...
public class LineItem {
    ...
    public boolean equals(Object o) {
        ...
        return lineItemId == lineItem.lineItemId && saleId == lineItem.saleId && productId == lineItem.productId && quantity == lineItem.quantity && Objects.equals(productName, lineItem.productName) && Objects.equals(price, lineItem.price);
    }

    @Override
    public int hashCode() {
        return Objects.hash(lineItemId, saleId, productId, quantity, productName, price);
    }
}
